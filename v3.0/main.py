...
parser.add_argument('--action', dest='action', type=str, help='parse or screen')
parser.add_argument('--pitch', dest='pitch', type=str, help='pitch forward (default 61) ')
